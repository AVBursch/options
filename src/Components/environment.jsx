            ...
            <React.Fragment>
                <table style={{ width: 500 }}>
                    <tbody>
                        <tr>
                            <td>
                                <label>{this.props.translations[this.props.language].background}:</label>
                                <br />
                                <select
                                ...
                                <br />
                                <label>{this.props.translations[this.props.language].sunSkyBrightness}:</label>
                                <br />
                            ...
                            <td>
                                <label>{this.props.translations[this.props.language].renderingMode}:</label>
                                <br />
                                <select
                                ...
                                <br />
                                <label>{this.props.translations[this.props.language].options}:</label>
                                <br />
