                            ...
                            <tr>
                                <td>
                                    <div style={{ height: 250, width: 250 }}>
                                        <label><b>{this.props.translations[this.props.language].imageSize}</b></label>
                                        <br />
                                ...
                                <td>
                                    <div style={{ height: 250, width: 250 }}>
                                        <label><b>{this.props.translations[this.props.language].imageFormat}</b></label>
                                        <br />
                                ...
                                <br />
                                        ...
                                        <br />
                                        <br />
                                        <label><b>{this.props.translations[this.props.language].imageSaveLocation}</b></label>
                                        <br />
